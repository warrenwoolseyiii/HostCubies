/*
  This a simple example of the aREST Library for the Arduino/Genuino MKR1000
  board. See the README file for more details.
...
// WiFi parameters
char ssid[] = "The Tree House";
char password[] = "a123456789";
